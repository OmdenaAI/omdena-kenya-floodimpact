...
def main():
    ...
    train_dataset = get_train_dataset(p, train_transforms, to_augmented_dataset=True,split='train')
    ...
    indices  = memory_bank_base.mine_nearest_neighbors(topk)
    ...
    # topk = 5
    # print('Mine the nearest neighbors (Top-%d)' %(topk)) 
    # indices = memory_bank_val.mine_nearest_neighbors(topk)
